...
# 또는 node songArchives/churahee/addVod.js "https://vod.sooplive.co.kr/player/189435111"
```

**체비**
```bash
npm run chebi2:add -- "https://vod.sooplive.co.kr/player/{videoId}"
# 또는 node songArchives/chebi2/addVod.js "https://vod.sooplive.co.kr/player/{videoId}"
```
